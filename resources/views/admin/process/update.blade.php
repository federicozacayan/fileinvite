    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <h2 class="d-flex justify-content-center"><b>{{ $left }} Days Left</b></h2>
                <div class="progress">
                    <div class="progress-bar progress-bar-striped bg-{{$bgColor}}" role="progressbar" style="width: {{((1-$left/$files[0]->requirements_days)*100)}}%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">
                        ...
                        @if (isset($files) && count($files) > 0)
                            @foreach ($files as $file)
                                <li class="list-group-item flex">
                                    ...
                                    <span><i class="fas fa-file"></i> #F{{$file->file_type_id}} - {{$file->file_type_name}}</span>
                                    ...
                                    @else
                                        <i aria-hidden="true" class="fas fa-eye-slash"></i> 
                                        <i class="fas fa-cloud-download-alt abailable"></i> 
